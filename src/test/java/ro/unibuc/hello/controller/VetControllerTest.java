...
public class VetControllerTest {
    ...
    public void testCreateVet() throws Exception {
        ...
        when(vetRepository.save(any(VetEntity.class))).thenReturn(savedVet);
    ...
    public void testUpdateVet() throws Exception {
        ...
        when(vetRepository.findById("1")).thenReturn(Optional.of(originalVet));
        when(vetRepository.save(any(VetEntity.class))).thenReturn(updatedVet);
