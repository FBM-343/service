...
public class AppointmentControllerTest {
        ...
        // AppointmentEntity originalAppointment = new AppointmentEntity(new
        // PetEntity("Rex", "Dog"), new VetEntity("Dr. Smith", "Medicina veterinara
        // interna"), LocalDateTime.now(), "Vaccinare");
        // originalAppointment.setId("1");
        //
        // AppointmentEntity updatedAppointment = new AppointmentEntity(new
        // PetEntity("Mex", "Cat"), new VetEntity("Dr. John", "Chirurgie veterinara"),
        // LocalDateTime.now(), "Operatie");
